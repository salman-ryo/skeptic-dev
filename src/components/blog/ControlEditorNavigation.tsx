...
const ControlEditorNavigation = ({title, description, tags, blocks}:ControlEditorNavigationProps) => {
  ...
  return (
    <>
     ...
     <AlertDialog open={isNavigationModalOpen} onOpenChange={setIsNavigationModalOpen}>
