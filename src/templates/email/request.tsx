...
export default function AuthorRequest({email , message,name } : RequestMessageType) {
  return (
    <Html>
        <Head/>
        <Preview>The Skeptic Dev: Author Request from ${name}</Preview>
        <Tailwind>
            <Body className='bg-cGray-dark text-white w-full'>
                <Container>
