...
import HTMLRenderer from "@/components/blog/v2/HTMLRenderer";
...
export async function generateMetadata(
  ...
  const coverImageUrl = getBlogImage(
    blog.blocks,
        ...
        {blog && (
          <article className="w-full md:w-[70%] mx-auto p-6">
            <header className="mb-8">
              {blog.tags && blog.tags.length > 0 && (
                <div className="flex justify-start items-center gap-x-4">
                  {blog.tags.map((tag, index) => (
                    ...
                    >
                      <span
                        className="text-lg font-medium text-gray-400 hover:text-gray-600 transition-colors duration-300 capitalize dark:text-cyan-400
                    max-md:text-xs
                    "
                      >
                        {tag}
              ...
              <h1
                className="text-5xl font-bold mt-8 mb-4 dark:text-gray-200
            max-md:text-4xl
            "
              >
                {blog.title}
              ...
              {blog.description && (
                <p
                  className="text-cGray text-lg font-medium mb-4 dark:text-cGray-light
              max-md:text-base
              "
                >
                  {blog.description}
                  ...
                  <div className="flex justify-start items-center space-x-2">
                    ...
                    "
                      ...
                      <div className="flex flex-col justify-start items-start text-gray-500">
                        <span
                          className="font-semibold dark:text-blue-400
                      max-md:text-sm
                      "
                        >
